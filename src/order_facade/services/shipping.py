...
class ShippingService:
    ...
    def create_shipment(self, customer_id: str, items: List[Dict], 
                       shipping_address: Optional[Dict] = None,
                       shipping_type: str = "standard") -> ShipmentInfo:
        """
        Crea un nuevo envío.
    ...
    def calculate_shipping_cost(self, items: List[Dict], 
                              shipping_type: str = "standard") -> float:
        """
        ...
        """
        base_cost = self._carriers.get(shipping_type, self._carriers["standard"])["cost"]
